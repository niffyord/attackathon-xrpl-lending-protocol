...
list(APPEND grpc_COMPONENT_NAMES gRPC::address_sorting gRPC::gpr gRPC::grpc_plugin_support gRPC::upb gRPC::grpc gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpcpp_channelz)
list(REMOVE_DUPLICATES grpc_COMPONENT_NAMES)
if(DEFINED grpc_FIND_DEPENDENCY_NAMES)
  list(APPEND grpc_FIND_DEPENDENCY_NAMES absl c-ares re2 OpenSSL protobuf ZLIB)
  list(REMOVE_DUPLICATES grpc_FIND_DEPENDENCY_NAMES)
else()
  set(grpc_FIND_DEPENDENCY_NAMES absl c-ares re2 OpenSSL protobuf ZLIB)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(grpc_PACKAGE_FOLDER_RELEASE "/root/.conan2/p/grpc39a01891b8038/p")
...
set(grpc_LIBS_RELEASE grpcpp_channelz grpc++_reflection grpc++_error_details grpc++_alts grpc++ grpc upb grpc_plugin_support gpr address_sorting)
...
set(grpc_COMPONENTS_RELEASE gRPC::address_sorting gRPC::gpr gRPC::grpc_plugin_support gRPC::upb gRPC::grpc gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpcpp_channelz)
...
set(grpc_gRPC_grpcpp_channelz_DEPENDENCIES_RELEASE protobuf::libprotobuf gRPC::grpc++)
...
set(grpc_gRPC_grpc++_reflection_DEPENDENCIES_RELEASE protobuf::libprotobuf gRPC::grpc++)
...
set(grpc_gRPC_grpc++_error_details_DEPENDENCIES_RELEASE protobuf::libprotobuf gRPC::grpc++)
...
set(grpc_gRPC_grpc++_alts_DEPENDENCIES_RELEASE protobuf::libprotobuf gRPC::grpc++)
...
set(grpc_gRPC_grpc++_DEPENDENCIES_RELEASE protobuf::libprotobuf absl::cleanup gRPC::grpc)
...
set(grpc_gRPC_gpr_DEPENDENCIES_RELEASE absl::base absl::core_headers absl::memory absl::random_random absl::status absl::cord absl::str_format absl::strings absl::synchronization absl::time absl::optional absl::variant)
