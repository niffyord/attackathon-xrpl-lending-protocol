...
set_property(TARGET grpc_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:absl::base;absl::core_headers;absl::memory;absl::random_random;absl::status;absl::cord;absl::str_format;absl::strings;absl::synchronization;absl::time;absl::optional;absl::variant;ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;re2::re2;gRPC::upb;absl::flat_hash_map;absl::flat_hash_set;absl::inlined_vector;absl::any_invocable;absl::bind_front;absl::function_ref;absl::hash;absl::type_traits;absl::statusor;absl::span;absl::utility;gRPC::gpr;OpenSSL::SSL;OpenSSL::Crypto;protobuf::libprotobuf;absl::cleanup;gRPC::grpc;gRPC::grpc++;protobuf::libprotoc>)
